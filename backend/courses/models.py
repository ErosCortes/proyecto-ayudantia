...
class Course(models.Model):
    ...
    metodo_seleccion = models.CharField(max_length=20,
                                        ...
                                        default='INDIVIDUAL')
    coordinador = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL,
...
class Section(models.Model):
    ...
    profesor = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL,
                                 null=True, blank=True, related_name='secciones')
    ...
    def __str__(self):
        return f"{self.course.codigo_curso} - NRC {self.nrc} ({self.semestre})"